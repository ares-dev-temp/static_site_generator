import unittest
from textnode import * #TextNode, TextType, text_node_to_html_node, split_nodes_delimiter, extract_markdown_images, split_nodes_image, text_to_textnodes, markdown_to_blocks
...
class TestTextNode(unittest.TestCase):
    ...
    def test_leaf_to_html_p(self):
        ...
        print( "some node to html i guess" )
        print( node.to_html() )
...
"""
    ...
    def test_block_to_block_type(self):
        ...
        #ordereed list block test
        text = "1. first numbered list text\n2. second numbered list text\n3. third numbered list text"
        block = block_to_block_type( text )
...
"""
    ...
    def test_extract_tiltle(self):
        text = "# This is Header Title "
        self.assertEqual(extract_tiltle(text), "This is Header Title")
